...
/**
 * @brief Receives a pointer "base" that points to a char array filled with
 * certain characters. We then iterate through this char array and randomly
 * choose to uppercase them. This modified char array gets passed to the pointer
 * of "mod", which points to another char array.
 *
 *
 *
